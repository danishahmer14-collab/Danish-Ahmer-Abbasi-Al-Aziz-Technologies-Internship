...
- `cv_image_classification.py` — main script: OpenCV preprocessing demo plus a basic CNN image classifier trained on CIFAR-10.
...
- `data/` — CIFAR-10 dataset, auto-downloaded by the script on first run.
